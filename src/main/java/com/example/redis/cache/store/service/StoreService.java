package com.example.redis.cache.store.service;
...
import com.example.redis.cache.store.domain.StoreDto;
import com.example.redis.cache.store.repo.StoreRepository;
...
public class StoreService {
    ...
    @CacheEvict(cacheNames = "storeAllCache", allEntries = true, cacheManager = "storeCacheManager")
    ...
    @Cacheable(cacheNames = "storeCache", key = "args[0]", cacheManager = "storeCacheManager")
    ...
    @Cacheable(cacheNames = "storeAllCache", key = "methodName", cacheManager = "storeCacheManager")
    ...
    @CachePut(cacheNames = "storeCache", key = "#result.id", cacheManager = "storeCacheManager")
    ...
    @Caching(evict = {
            @CacheEvict(cacheNames = "storeCache", key = "args[0]", cacheManager = "storeCacheManager"),
            @CacheEvict(cacheNames = "storeAllCache", allEntries = true, cacheManager = "storeCacheManager")
    })
